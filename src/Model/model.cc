...
// s21::ModelDefault::ModelDefault(std::string str) { this->str_ = str; }

// s21::ModelDefault::~ModelDefault() {
// }  // TODO если не нужен будет то надо убрать
...
// s21::ModelDefault::stack_tt* stack_free_(stack_tt* list) {
//   while (list != NULL) {
